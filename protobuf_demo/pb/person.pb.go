...
type Person struct {
	...
	Id   int64  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // 可以不从1开始，但是不能重复。不能使用编号：19000-19999
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// 枚举
	Gender GenderType `protobuf:"varint,3,opt,name=gender,proto3,enum=pb.GenderType" json:"gender,omitempty"`
	...
	//	*Person_Province
	//	*Person_City
	Address isPerson_Address `protobuf_oneof:"address"`
}
...
func (m *Person) GetAddress() isPerson_Address {
	if m != nil {
		return m.Address
	}
	return nil
...
func (x *Person) GetProvince() string {
	if x, ok := x.GetAddress().(*Person_Province); ok {
		return x.Province
	}
	return ""
}
...
func (x *Person) GetCity() string {
	if x, ok := x.GetAddress().(*Person_City); ok {
		return x.City
	}
	return ""
}

type isPerson_Address interface {
	isPerson_Address()
}

type Person_Province struct {
	Province string `protobuf:"bytes,5,opt,name=province,proto3,oneof"`
}

type Person_City struct {
	City string `protobuf:"bytes,6,opt,name=city,proto3,oneof"`
}

func (*Person_Province) isPerson_Address() {}

func (*Person_City) isPerson_Address() {}
...
type ContactBook struct {
	...
	Persons []*Person `protobuf:"bytes,1,rep,name=persons,proto3" json:"persons,omitempty"` // 数组
}
...
var file_person_proto_rawDesc = []byte{
	...
	,
...
var file_person_proto_goTypes = []interface{}{
	(GenderType)(0),     // 0: pb.GenderType
	(*Person)(nil),      // 1: pb.Person
	(*ContactBook)(nil), // 2: pb.ContactBook
}
var file_person_proto_depIdxs = []int32{
	0, // 0: pb.Person.gender:type_name -> pb.GenderType
	1, // 1: pb.ContactBook.persons:type_name -> pb.Person
